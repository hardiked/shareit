...
<div style="background-color: turquoise;border-top-left-radius: 5px;border-top-right-radius: 5px;  ">
    <div class="container" style="margin-top:10%;margin-left:25%;width:45%;">
      <ul class="nav nav-tabs" role="tablist" style="color:red;">
        <li class="active" style="border-bottom: 3px solid blue;"><a href="#">SUBMIT YOUR POEM</a></li>
      </ul></div>
      <div class="panel panel-primary" style="margin-top:0%;">
      <div class="panel-body">
                            <form method="post" action="share_submit.php">
                                <input type="text" class="form-control form-group input-lg" placeholder="Poem Title" name="poemtitle" required>
                                <textarea rows="4" cols="50" placeholder="Type Your Poem Here...." class="form-control form-group input-lg" name="poem" required></textarea>
